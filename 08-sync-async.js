...
/**
 *  Normalnya, kode akan dijalankan secara berurutan dari kode baris paling atas sampai baris paling bawah
 *
 ...
 *
 *  Demi kenyamanan programmer, beberapa fungsi dan library Nodejs telah asynchron,
 *  contoh seperti pada lab sebelumnya yakni req dan res yang bergantung pada event.
 *
 */
 ...
 *
 *  Modul yang digunakan adalah fs (filesystem)
 *
 *  Skenarionya:
 *      1. User membuat request di postman dengan method post endpoints /login
 *      2. Mulai timer
